...
test('OP-04 event-start recomputes before persisting and wires one result into cards, graph, trace and report', async () => {
  ...
  assert.match(operator, /אין event evidence פעיל לקבוצה; התבנית לא נשמרה/);
