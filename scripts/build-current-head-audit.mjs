...
const VERIFIED = {
  ...
  'BW-GOV-010': ['docs/documentation-sync.json', 'core/docs/ALGORITHMIC_CORE_RESEARCH_LOG_HE.md', 'core/docs/IMPLEMENTATION_STATUS_HE.md', 'scripts/verify-documentation-sync.mjs', 'tests/documentation-sync.test.mjs', '.github/workflows/release-gate.yml'],
