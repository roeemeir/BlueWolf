...
export function GtScenarioWorkbench() {
  ...
  return <section className="glass-panel" dir="rtl" data-requirements="BW-DEV-008 BW-DEV-015" style={{ padding: 16, marginBottom: 16 }}>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "minmax(260px,.8fr) minmax(0,2fr)", gap: 14, marginTop: 12 }}>
      ...
      <div style={{ display: "grid", gap: 12 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}><Button variant="outline" onClick={() => addGroup("SI")}><Plus />קבוצת SI</Button><Button variant="outline" onClick={() => addGroup("SO")}><Plus />קבוצת SO</Button></div>
